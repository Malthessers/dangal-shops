...
const products = {
    1: {
        ...
        price: "₱350.00",
        oldPrice: "",
        brand: "Hablon Styles and Hues",
        location: {
            name: "Cagayan Valley",
            url: "https://maps.app.goo.gl/VLv2Sq383DcjbBiY8" // Add the URL here
        },
        description: "Authentic Sabutan bags, meticulously handwoven by skilled artisans in Cagayan using locally sourced sabutan leaves. Each bag showcases the natural beauty and enduring craftsmanship of the region, featuring intricate weaves and durable construction. Perfect for adding a touch of sustainable elegance to your style, for everyday use, or as a unique, eco-friendly accessory. Each bag is a testament to the rich cultural heritage and resourcefulness of Cagayan weavers",
        images: ["../luzonimages/cagayan1.png", "../luzonimages/cagayan4.png"],
        reviews: "(34 reviews)"
    },
    2: {
        name: "Sabutan Bag",
        ...
        description: "Authentic Sabutan bags, meticulously handwoven by skilled artisans in Cagayan using locally sourced sabutan leaves. Each bag showcases the natural beauty and enduring craftsmanship of the region, featuring intricate weaves and durable construction. Perfect for adding a touch of sustainable elegance to your style, for everyday use, or as a unique, eco-friendly accessory. Each bag is a testament to the rich cultural heritage and resourcefulness of Cagayan weavers",
        images: ["../luzonimages/cagayan2.png", "../luzonimages/cagayan4.png"],
        reviews: "(42 reviews)"
    },
    3: {
        name: "Capiz Shell Lantern",
        price: "₱1,560.00",
        oldPrice: "₱1,800.00",
        brand: "Ricohermoso",
        location: {
            name: "Ilocos Region", 
            url: "https://www.instagram.com/eliasilocosgoods/" // Add the URL here  
        },
        description: "Authentic Capiz shell lanterns, meticulously handcrafted by skilled artisans in Cagayan using locally sourced, delicate capiz shells. Each lantern showcases the natural luminescence and intricate craftsmanship of the region, creating a warm and inviting ambiance. Perfect for adding a touch of coastal elegance to your home, for festive occasions, or as a unique decorative piece. Each lantern is a testament to the rich cultural heritage and skilled artistry of Cagayan artisan.",
        images: ["../luzonimages/cagayan3.png"],
        reviews: "(54 reviews)"
    },
    4: {
        name: "Classic Two-Toned Abaca ",
        price: "₱1,495.00",
        oldPrice: "₱2,000.00",
        brand: "Allganic Store",
        location: {
            name: "Tabaco, Bicol Region",
            url: "https://maps.app.goo.gl/w5k2iMhosQfKDbHd6" // Add the URL here
        },
        description: "Elegant and sophisticated table runner handcrafted from premium woven fabric. Perfect for enhancing your dining presentation or adding a decorative accent to your console table. Each piece measures 180cm x 35cm and features intricate detailing along the borders for a refined finishing touch.",
        images: ["../bimages/b4.png"],
        reviews: "(15 reviews)"
    },
   
    // if u wanna add more products just add 
