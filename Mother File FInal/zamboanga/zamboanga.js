...
const products = {
    1: {
        name: "Weave Yakan Teen",
        price: "₱2,499.00",
        oldPrice: "",
        brand: "Beagiver",
        location: {
            name: "Makati, Philippines",
            url: "https://web.facebook.com/tiendaverdaph#" // Add the URL here
        },
        description: "Weave Yakan Teen, A limited edition bag features the hand-woven Yakan fabric from Zamboanga",
        images: ["../mindanaoimg/weaveyakanzp.jpg", "../mindanaoimg/weaveyakanzp1.jpg", "../mindanaoimg/weaveyakanzp2.jpg"],
        reviews: "(2 reviews)"
    },
    2: {
        name: "Creation Sun Catchers with Beaded tassels",
        price: "₱172.00",
        oldPrice: "",
        brand: "PHILIPPINES SUBANEN CRAFTS",
        location: {
            name: "Zamboanga, Philippines",
            url: "https://maps.app.goo.gl/CR796A7m1qAE5jex6#" // Add the URL here
        },
        description: "Each colorful Sun Catcher is a pendant that celebrates an important Birth in the story of Creation.  Hundreds of tiny seed beads are used, and each pendant is crafted with one strand of thread. The meaning of each Sun Catcher is given below.",
        images: ["../mindanaoimg/creationsunzp.jpg"],
        reviews: "(42 reviews)"
    },

    3: {
        name: "Creation Key-chain",
        price: "₱115.00",
        oldPrice: "",
        brand: "PHILIPPINES SUBANEN CRAFTS",
        location: {
        ...
        description: "Each colorful Key-chain is a pendant that celebrates an important Birth in the story of Creation. Hundreds of tiny seed beads are used, and each pendant is crafted with one strand of thread.",
        images: ["../mindanaoimg/creationkeychainzp.jpg"],
        reviews: "(42 reviews)"
    },
    4: {
        name: "Planet Bracelet",
        price: "₱400.00",
        oldPrice: "",
        brand: "PHILIPPINES SUBANEN CRAFTS",
        location: {
        ...
        description: "The semi-precious stones and cat's eye beads in this bracelet mimic the actual colors of the planets.  The spacer beads are made of hematite.",
        images: ["../mindanaoimg/planetbraceletzp.jpg"],
        reviews: "(42 reviews)"
    },
