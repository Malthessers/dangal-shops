...
const products = {
    1: {
        name: "Manobo Beaded Ethnic/ Native/ Tribal Necklace",
        price: "₱750.00",
        oldPrice: "",
        brand: "Madyaw Kadyaw Souvenir Shoppe",
        
        location: {
            name: "Butuan City, Agusan Del Norte, Philippines",
            url: "https://maps.app.goo.gl/p51bsgpEQpafoN8C6#" // Add the URL here
        },
        description: "These accessories are worn by native Manobo women. The Manobo of Caraga in the Philippines is known for its complicated beadwork. This pair of hand-beaded necklaces show Manobo craftsmanship at its best. These products have helped uplift the lives of the tribe and improved their living while preserving their cultural heritage.",
        images: ["../mindanaoimg/manobobeadedcrg.png", "../mindanaoimg/manobobeadedcrg1.png"],
        reviews: "(5 reviews)"
    },
    2: {
        name: "Angkolo Tribal Headdress",
        price: "₱1,200.00",
        oldPrice: "",
        brand: "Madyaw Kadyaw Souvenir Shoppe",
        location: {
        ...
        description: "Cloth with beaded Tangkolo or Manobo headdress for Men. Free size can be adjusted",
        images: ["../mindanaoimg/angkolocrg.png"],
        reviews: "(42 reviews)"
    },
    3: {
        name: "April Tote Bag",
        ...
        brand: "Binuhat",
        location: {
            name: "San Jose, Dinagat Islands, Philippines",
            url: "https://maps.app.goo.gl/Z1ukLXssoZyEXGko6#" // Add the URL here
        },
        description: "The weaving is called sinansan, it is light weight, its open top, its roomy, it has a lock and its multi-purpose. It can be used in beach trips, for processing paper works, and it can be so fashionable just accent it with a shoal.",
        images: ["../mindanaoimg/apriltotecrg.jpg"],
        reviews: "(18 reviews)"
    },
    4: {
        name: "Surigao's Peanut Delight",
        price: "₱99.00",
        oldPrice: "",
        brand: "Rembrandt's",
        location: {
            name: "Surigao City, Surigao Del Norte, Philippines",
            url: "https://maps.app.goo.gl/EiNMYuNqLCNudZZ3A#" // Add the URL here
        },
        description: "Surigao's Peanut Delight is a must-try treat that perfectly embodies the rich culinary heritage of the city. Made from high-quality peanuts, caramelized sugar, and a touch of local flair, this sweet and crunchy delicacy is loved by all. Whether as a pasalubong (souvenir) or a snack for yourself, Peanut Delight is sure to bring a smile with every bite. Taste the pride of Surigao City today!",
        images: ["../mindanaoimg/surigaopeanutcrg.jpg", "../mindanaoimg/surigaopeanutcrg1.jpg"],
        reviews: "(15 reviews)"
    },
    5: {
        name: "Needaz Handbag",
        ...
        description: " This beautiful handwoven plastic rattan handbag is a perfect blend of modern sophistication and traditional craftsmanship. Featuring a chic and durable design, it is thoughtfully crafted by skilled artisans who pour their creativity and precision into every detail.",
        images: ["../mindanaoimg/needazhandbagcrg.jpg"],
        reviews: "(15 reviews)"
    },
    6: {
        name: "Ampaw Rice Crispies",
        price: "₱69.00",
        oldPrice: "",
        brand: "Rembrandt's",
        location: {
        ...
        description: "Ayo's Ampao Rice Crispies from Placer, Surigao del Norte, is a timeless Filipino delicacy crafted with love and tradition. Made from perfectly puffed rice, sweet caramel syrup, and peanuts, it delivers a delightful crunch that’s both satisfying and nostalgic. Ideal as a pasalubong (souvenir) or a snack, Ayo's Ampao is a true taste of Surigao’s heritage. Relish the joy of every crispy bite today!",
        images: ["../mindanaoimg/ampawcrg.jpg", "../mindanaoimg/ampawcrg1.jpg"],
        reviews: "(15 reviews)"
    },
