...
const products = {
    1: {
        name: "Kape Dulangan (200g)",
        price: "₱145.00",
        oldPrice: "",
        brand: "LJ&C Manganaan Minimart",
        location: {
            name: " Quezon City, Philippines",
            url: "https://maps.app.goo.gl/tWZd7uSe6W5TvGaC9#" // Add the URL here
        },
        description: "Kape Dulangan- robusta coffee grown and processed by the Manobo Dulangan of Sultan Kudarat. 400 small coffee farmers supply coffee beans, of whom 200 commit to good agricultural",
        images: ["../mindanaoimg/kapedulangansoccs.jpg", "../mindanaoimg/kapedulangansoccs1.jpg"],
        reviews: "(24 reviews)"
    },
    2: {
        name: "Sarangani Bay Milkfish in Corn Oil Spicy (312g)",
        price: "₱246.00",
        oldPrice: "",
        brand: "S&R Membership Shopping",
        location: {
            name: "Mandaluyong, Metro Manila, Philippines",
            url: "https://maps.app.goo.gl/rHAC7QgjfFwgMnLp8#" // Add the URL here
        },
        description: "This is something that’s completely off the hook, no fishy smell that will leave you skeptical. In all its purest and sincerest offering, Sarangani Bay gives us another blessing in a jar. It’s their Sarangani Bay Milkfish in Corn Oil Spicy. A melt-in-your-mouth treat that you would definitely love in every bite. Pair it with your warm rice or try to invent a new pasta flavor with it. Whatever floats your boat, you will definitely set sail in sea of flavorful goodness with Sarangani Bay.",
        images: ["../mindanaoimg/saranganibaysoccs.jpg", "../mindanaoimg/saranganibaysoccs1.jpg"],
        reviews: "(42 reviews)"
    },
    3: {
        name: "Royal Handwoven Inaul Malong",
        price: "₱1,800.00",
        oldPrice: "₱2,000.00",
        brand: "Malong Maguindanaon - Filipino Indigenous Handwoven Fabrics Malong",
        location: {
            name: "Mandaluyong, Metro Manila, Philippines",
            url: "https://maps.app.goo.gl/JCosPpfeTUaXY6bp8#" // Add the URL here
        },
        description: "The long-awaited Royal Handwoven Inaul Malong in Sutra Rayon Silk is finally here! Authentically woven in Sultan Kudarat Municipality, Maguindanao del Norte, by our skilled native master weavers—both men and women, alongside their apprentices. Each piece in this collection is one of a kind, a true masterpiece of tradition and craftsmanship.",
        images: ["../mindanaoimg/royalhandwovensoccs.jpg", "../mindanaoimg/royalhandwovensoccs1.jpg"],
        reviews: "(18 reviews)"
    },
};
