...
const products = {
   ...
   1: {
    name: "Tikog Handwoven Tote Bag with Flower Design",
    price: "₱2,999.00",
    oldPrice: "",
    brand: "KULTURA",
    location: {
        name: "Taguig City, Philippines",
        url: "https://maps.app.goo.gl/gU7bwygdvPzCc2zU9#" // Add the URL here
    },
    description: "Made from Tikog. Braided handle. Zip closure. Handwoven by Filipino Artisans",
    images: ["../visayasimg/tikoghandwovenev.jpg"],
    reviews: "(24 reviews)"
},
2: {
    name: "Ordinary Walis Tambo - (Gawang Samar)",
    price: "₱200.00",
    oldPrice: "",
    brand: "THE FAITH BASE-PH",
    location: {
        name: "Imus, Cavite, Philippines",
        url: "https://maps.app.goo.gl/SoVDH3nHCnoyZvYUA#" // Add the URL here
    },
    description: "Ordinary Walis Tambo. Gawang Samar, matibay, hindi naglalagas",
    images: ["../visayasimg/walisgawangsamarev.jpg", "../visayasimg/walisgawangsamarev1.jpg"],
    reviews: "(42 reviews)"
},
